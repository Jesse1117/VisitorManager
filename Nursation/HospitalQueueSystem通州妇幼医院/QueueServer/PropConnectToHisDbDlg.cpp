...
BOOL CPropConnectToHisDbDlg::OnInitDialog()
{
	...
	m_strPWD = CommonStrMethod::GetPrivateProfileStringMy(
		_T("conn"), _T("PASSWORD"), _T("bjlb2014"), _T("\\SYS\\hisdb.ini"));
	m_strHostIP = CommonStrMethod::GetPrivateProfileStringMy(
		_T("conn"), _T("HOST"), _T("127.0.0.1"), _T("\\SYS\\hisdb.ini"));
	m_strPort = CommonStrMethod::GetPrivateProfileStringMy(
		_T("conn"), _T("PORT"), _T("1521"), _T("\\SYS\\hisdb.ini"));
	m_strServiceName = CommonStrMethod::GetPrivateProfileStringMy(
