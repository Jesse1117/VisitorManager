...
void CListCtrlCl::SetColColor(int col,COLORREF color) //设置列颜色
{
	...
	for (POSITION pos = m_ptrListCol.GetHeadPosition();pos!=NULL;)
	{
		...
		if (pColor->nCol==col)
		{
			flag=1;
			pColor->rgb=color;
			m_ptrListCol.SetAt(poslast,pColor);
			break;
		}
	}
	if(0==flag)
...
void CListCtrlCl::SetItemColor(int col,int row,COLORREF color) //设置格子颜色
{
	...
	for (POSITION pos = m_ptrListItem.GetHeadPosition();pos!=NULL;)
	{
		...
		if (pColor->nCol==col && pColor->nRow==row)
		{
			flag=1;
			pColor->rgb=color;
			m_ptrListItem.SetAt(poslast,pColor);
			break;
		}
	}
	if(0==flag)
...
void CListCtrlCl::SetColTextColor(int col,COLORREF color)
{
	...
	for (POSITION pos = m_colTextColor.GetHeadPosition();pos!=NULL;)
	{
		...
		if (pColor->nCol==col)
		{
			flag=1;
			pColor->rgb=color;
			m_colTextColor.SetAt(poslast,pColor);
			break;
		}
	}
	if(0==flag)
...
void CListCtrlCl::SetItemTextColor(int col,int row,COLORREF color)
{
	...
	for (POSITION pos = m_ItemTextColor.GetHeadPosition();pos!=NULL;)
	{
		...
		if (pColor->nCol==col && pColor->nRow==row)
		{
			flag=1;
			pColor->rgb=color;
			m_ItemTextColor.SetAt(poslast,pColor);
			break;
		}
	}
	if(0==flag)
...
void CListCtrlCl::ReleaseInfo()
{
	POSITION pos = m_ptrListItem.GetHeadPosition();
	while(pos)
	{
		stColor *pColor = NULL; 
		pColor = (stColor*)m_ptrListItem.GetNext(pos);
		if(pColor)
		{
			delete pColor;
			pColor = NULL;
...
/////////////////////////////////////////////
	pos = m_ptrListCol.GetHeadPosition();
	while(pos)
	{
		stColor *pColor = NULL; 
		pColor = (stColor*)m_ptrListCol.GetNext(pos);
		if(pColor)
		{
			delete pColor;
			pColor = NULL;
	...
	///////////////////////////////////////////////
	pos = m_colTextColor.GetHeadPosition();
	while(pos)
	{
		stColor *pColor = NULL; 
		pColor = (stColor*)m_colTextColor.GetNext(pos);
		if(pColor)
		{
			delete pColor;
			pColor = NULL;
	...
	////////////////////////////////////////////////////
	pos = m_ItemTextColor.GetHeadPosition();
	while(pos)
	{
		stColor *pColor = NULL; 
