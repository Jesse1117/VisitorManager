...
BOOL CNurseStationApp::InitInstance()
{
	...
	//让程序开机启动
	CommonStrMethod::AddAutoRun(_T("NurseStation"));
	...
	////////////////////////////////////////////////////
	/////////////////	弹出登录界面	////////////////
	CDoc_NurseDlg* pdlg = new CDoc_NurseDlg;
	...
	m_pNurseController->SetUserId(pdlg->GetUserId());
	delete pdlg;
...
BOOL CNurseStationApp::AddAutoRun(CString strValueName)
{
	...
	//CString strPath = CommonStrMethod::GetModuleFileName();
