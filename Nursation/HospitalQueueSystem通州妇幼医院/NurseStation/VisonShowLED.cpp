...
{
 	long index = CreateData(msg,rect,lShowTime);//生成发送数据
...
// 		"宋体",12,RGB(255,255,0),WFS_BOLD, 1, 0, 20, 2, 1, 2, 0, 1, 10000);
// 	
// 	AddLeaf(index,10*1000,LED_WAIT_CHILD);
// 	AddText(index,0,0,128,48,0,0,"董晨 is a bitch",
// 		"宋体",12,RGB(255,255,0),WFS_BOLD, 1, 0, 20, 2, 1, 2, 0, 1, 10000);
...
// 		"同一个世界同一个世界同一个世界同一个世界", "宋体", 12, RGB(255,255,0), WFS_NONE, V_TRUE, 0, 7, 5, 1, 5, 0, 1, 3000);
