...
//	m_date=CTime::GetCurrentTime();
	...
	int nEnable = CommonStrMethod::GetPrivateProfileIntMy(
...
void CNurseView::NoHisWriteDataToQueue()
{
	...
	while(pos!=NULL)
	{
		...
		if(office.GetQueID()==Queue)
		{
			...
			if(!rset.Open(sql,CADORecordset::openQuery))
			{
				return;
			}
