...
CStbPropDlg::CStbPropDlg()
	...
	, m_strStbId(_T(""))
{
	m_strSqlQuerry = _T("select stb_id,stb_name,stb_ip,stb_port,stb_init_text from SetTopBox;");
}
...
BOOL CStbPropDlg::OnInitDialog()
{
	...
	m_lcRoomList.InsertColumn(1, _T("名称"), LVCFMT_CENTER, nColWidth * 2);
	m_lcRoomList.InsertColumn(2, _T("地址"), LVCFMT_CENTER, nColWidth * 2);
	m_lcRoomList.InsertColumn(3, _T("端口"), LVCFMT_CENTER, nColWidth * 1);
	m_lcRoomList.InsertColumn(4, _T("启动显示"), LVCFMT_CENTER, nColWidth * 4);
