...
BEGIN_MESSAGE_MAP(CPrintSetDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_SERIAL_ID, &CPrintSetDlg::OnBnClickedSerialId)
	ON_BN_CLICKED(IDC_CONSULT_NAME, &CPrintSetDlg::OnBnClickedConsultName)
	ON_BN_CLICKED(IDC_DOCTOR_NAME, &CPrintSetDlg::OnBnClickedDoctorName)
	ON_BN_CLICKED(IDC_PRINT_ISCHECK, &CPrintSetDlg::OnBnClickedPrintIscheck)
END_MESSAGE_MAP()
...
void CPrintSetDlg::OnBnClickedSerialId()
{
	// TODO: 在此添加控件通知处理程序代码
	m_bIsAddPicture = FALSE;
	m_bIsAddText = TRUE;
...
void CPrintSetDlg::OnBnClickedConsultName()
{
	// TODO: 在此添加控件通知处理程序代码
	m_bIsAddPicture = FALSE;
	m_bIsAddText = TRUE;
...
void CPrintSetDlg::OnBnClickedDoctorName()
{
	// TODO: 在此添加控件通知处理程序代码
	m_bIsAddPicture = FALSE;
	m_bIsAddText = TRUE;
...
void CPrintSetDlg::OnBnClickedPrintIscheck()
{
	// TODO: 在此添加控件通知处理程序代码
	CButton* pButton = (CButton*)GetDlgItem(IDC_PRINT_ISCHECK);
...
BOOL CPrintSetDlg::LoadPrintRectInfoFormFile()
{
